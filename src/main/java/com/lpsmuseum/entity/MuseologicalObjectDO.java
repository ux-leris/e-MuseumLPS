 ...
 * </ul>
 * <p>
 * This entity can be specialized to represent image or text. For 
 * such, this entity has a <u>type descriminator</u> column of type String and the 
 * possible values are:
 * <ul>
...
public class MuseologicalObjectDO implements Serializable {
	...
	/**
	 * This field represents the scenario's name and can't be null. The 
	 * column's name in the table is <code>name</code>.
	 */
	@NotNull
	@Column(name="name")
	private String name;
	...
	/**
	 * Returns the id of the museological object.
	 * 
	 * @return the id of the museological object.
	 */
	public Long getId() {
		return id;
	}
	...
	/**
	 * Sets the id of the museological object.
	 * 
	...
	/**
	 * Returns the name of the museological object.
	 * 
	 * @return the name of the museological object.
	 */
	...
	/**
	 * Sets the name of the museological object.
	 * 
	...
	/**
	 * Returns the type of the museological object.
	 * @return the type of the museological object.
	 */
	...
	/**
	 * Sets the type of the museological object.
	 * @param objectType the type of the museological object.
	 */
	...
	/**
	 * Returns the date of the museological object.
	 * @return the date of the museological object.
	 */
	public Date getDate() {
		return date;
	}
	...
	/**
	 * Sets the date of the museological object.
	 * @param date the date of the museological object.
	 */
