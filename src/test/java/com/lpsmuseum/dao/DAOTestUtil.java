...
public class DAOTestUtil {
    ...
    public static ArrayList<MuseologicalObject> generateMuseologicalObjects() {
        ...
        object.setName("object one");
        object.setDate(Calendar.getInstance());
        objects.add(object);
        object = new MuseologicalObject();
        object.setName("object two");
        object.setDate(Calendar.getInstance());
        objects.add(object);
        object = new MuseologicalObject();
        object.setName("object three");
        object.setDate(Calendar.getInstance());
        objects.add(object);
        object = new MuseologicalObject();
        object.setName("object four");
        object.setDate(Calendar.getInstance());
        objects.add(object);
        object = new MuseologicalObject();
        object.setName("object five");
        object.setDate(Calendar.getInstance());
        objects.add(object);
    ...
    public static ArrayList<Scenario> generateScenarios() throws Exception {
        ...
        scenario.setName("scenario three");
        scenario.setObjects(subObjects);
        scenario.setTheme(theme);
    ...
    public static ArrayList<Museum> generateMuseuns() throws Exception {
        ...
        for (int i = 0; i < scenarios.size() - 1; i += stepScenario) {
            ...
            subScenarios.add(scenarios.get(i));
        }
        //museums.add(builder.withNavigation(new AleatoryNavigation()).build("Museum One"));
        museums.add(new Museum("museum one", scenarios));

        //builder.clear();
        subScenarios = new ArrayList<Scenario>();
